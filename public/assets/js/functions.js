(function($){
	...
	$(document).ready(function(){
		...
		var large_html = '<div class="theme_option"><div class="theme_option_in"><div class="theme_option_in2"><div class="option_header"><h4>Style Options</h4><a href="#" class="open_options animate"><i class="ico-cog3"></i></a></div><div class="option_block clearfix"><h4 class="option_title">Color Scheme</h4><ul class="option_color_list clearfix"><li><a class="color_scheme animate op_color_a" href="#" data-color="#CD2122" data-color-a="#3A2B2B" data-color-b="#2C1D1D"></a></li><li><a class="color_scheme animate op_color_b" href="#" data-color="#00AFB2" data-color-a="#2d414b" data-color-b="#22323A"></a></li><li><a class="color_scheme animate op_color_c" href="#" data-color="#009673" data-color-a="#334947" data-color-b="#203837"></a></li><li><a class="color_scheme animate op_color_d" href="#" data-color="#9854B3" data-color-a="#2A2A2A" data-color-b="#1A1A1A"></a></li><li><a class="color_scheme animate op_color_e" href="#" data-color="#F86923" data-color-a="#2F2E2E" data-color-b="#1F1E1E"></a></li><li><a class="color_scheme animate op_color_f" href="#" data-color="#D91897" data-color-a="#412E36" data-color-b="#322229"></a></li><li><a class="color_scheme animate" href="#" data-color="#374F99"></a></li><li><a class="color_scheme animate" href="#" data-color="#684035"></a></li><li><a class="color_scheme animate" href="#" data-color="#178E94"></a></li><li><a class="color_scheme animate" href="#" data-color="#973A4B"></a></li><li><a class="color_scheme animate" href="#" data-color="#F3605D"></a></li><li><a class="color_scheme animate" href="#" data-color="#79AF33"></a></li></ul></div><div class="option_block clearfix" data-toggle-class="site_boxed" data-toggle-on="body"><h4 class="option_title">Layout</h4><a class="option_button active" data-event="class_remove" href="#">Wide</a><a class="option_button" data-event="class_add" href="#">Boxed</a></div> <!--<div class="option_block clearfix" data-toggle-class="dark" data-toggle-on="body"><h4 class="option_title">Dark & Light</h4><a class="option_button active" data-event="class_remove" href="#">Light</a><a class="option_button" data-event="class_add" href="#">Dark</a></div>--> <div class="option_block clearfix" data-toggle-class="light_header" data-toggle-class-two="dark_header" data-toggle-on="body"><h4 class="option_title">Navigation Color</h4><a class="option_button active" data-event="class_add" href="#">Light</a><a class="option_button" data-event="class_remove" href="#">Dark</a></div> <div class="option_block clearfix" data-toggle-class="dark_sup_menu" data-toggle-on="body"><h4 class="option_title">SupMenu Color</h4><a class="option_button" data-event="class_remove" href="#">Light</a><a class="option_button active" data-event="class_add" href="#">Dark</a></div></div></div></div>';
		...
		$('a.open_options').on('click', function(e) {
		...
		$('a.option_button').on('click', function(event) {
			var $this_btn = $(this);
			...
			var toogle_class2 = $this_btn.parent(".option_block").attr("data-toggle-class-two") ? $this_btn.parent(".option_block").attr("data-toggle-class-two") : "";
			...
			//=====> toogle_class
			if(btn_event == "class_add" ){
				$(toogle_on).addClass(toogle_class);	
				$(toogle_on).removeClass(toogle_class2);
						
			}else if(btn_event == "class_remove" ){
				$(toogle_on).removeClass(toogle_class);	
				$(toogle_on).addClass(toogle_class2);		
			}
